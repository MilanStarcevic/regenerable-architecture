"""
Duplication Check Fitness Function

Measures code duplication in Python source files.
Duplication in AI-generated code is a strong slop signal:
the model generated the same solution twice without recognizing it.

Heuristic approach:
  - Normalize non-empty source lines (strip whitespace, lowercase)
  - Count lines that appear more than once across all files
  - Count repeated N-gram blocks (sequences of normalized lines)
